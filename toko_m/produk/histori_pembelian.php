...
<table class="table table-hover table-striped">
    ...
    <tbody>
        <?php
            ...
            $no++;
            $hapus="<a href='hapus_histori.php?id_transaksi=$dt_histori[id_transaksi]' onclick='return confirm(Apakah anda yakin menghapus Histori ini?)' class='btn btn-danger'>hapus
            </a>";
        ?>
    ...
    <a href="tampil_produk.php" class="btn btn-primary">beli lagi duit masih banyak</a>
</table>
